...
const products = [
    ...
    { id: 2, name: 'Coffee Maker', description: 'Pour-over', price: '$115', image: 'https://store.chemexcoffeemaker.com/media/catalog/product/c/h/chemex-classic-6cup-detail_1.png'},
